...
static const std::unordered_map<GLenum, const char *> sourceEnumToString = { { GL_DEBUG_SOURCE_API, "API" },
...
static const std::unordered_map<GLenum, const char *> typeEnumToString = { { GL_DEBUG_TYPE_ERROR, "ERROR" },
...
static std::array<std::tuple<const char *, bool, GLenum>, 4> severitySelector = { std::make_tuple("HIGH", true, GL_DEBUG_SEVERITY_HIGH),
